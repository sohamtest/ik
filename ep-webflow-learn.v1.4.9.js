...
if(eventName != ""){
  $(".webinar__lightbox-title").text("Don't Let Opportunities Slip Away: Study AI/ML to Future-Proof Your Tech Career");
	$('input[name="Event Name"]').val("Don't Let Opportunities Slip Away: Study AI/ML to Future-Proof Your Tech Career");
}
