...
$(document).ready((function () {
  ...
  function a(e) {
    ...
    for (i = 0; i < o; i++) {
      ...
      "v2" == webinarUI ? ($(".webinar__slots").empty().append($(c)), $(".webinar__slots").addClass("slot-grid"), $(".ws-available-slots").css("color", "#0E9F1C"), $(".ws-card:first-child").find(".ws-available-slots").css("color", "#D14040"), $(".ws-card:nth-child(2)").find(".ws-available-slots").css("color", "#ED7735"), $(".ws-card").find(".ws-almost-full").hide(), $(".ws-card:first-child").find(".ws-almost-full").show(), $(".ws-card:nth-child(2)").find(".ws-almost-full").text("Filling fast!").addClass("ws-filling-fast"), $(".ws-filling-fast").css("display", "block")) : $(".webinar__slots").empty().append($(m))
    }
  }
