 ...
 * Original file: https://cdn.jsdelivr.net/gh/sohamtest/ik@AnkurDev/ep-webinar-us.v5.min.js
 *
  ...
  function a(e) {
    ...
    for (i = 0; i < o; i++) {
      ...
      var d = e[i].weekday + ", " + e[i].day + " " + a[parseInt(e[i].month) - 1] + " " + e[i].year + " | " + e[i].hour + ":" + e[i].minute + " " + e[i].am_or_pm,
        m = '<div class="calender-webinar-slot-box"><div class="webinar_timer_date-time"><div class="webinar_timer_day">' + e[i].weekday + '</div><div class="webinar_timer_time">' + e[i].day + '</div></div><label class="webinar-timer-slot-block w-radio" data-weekday="' + e[i].weekday + '" data-date="' + e[i].day + '" data-time="' + time + '" ><div class="w-form-formradioinput w-form-formradioinput--inputType-custom radio_button webinar-timer-slot w-radio-input"></div > <input type="radio" id="' + e[i].start_time + '" data-endtime="' + e[i].end_time + '" name="time-slot" value="' + e[i].start_time + '" data-name="time slot" data-invitee_starttime="' + e[i].invitee_start_time + '" data-invitee_endtime="' + e[i].invitee_end_time + '" style="opacity:0;position:absolute;z-index:-1"><span for="' + e[i].start_time + '" class="webinar-timer-text w-form-label">' + time + '</span><div class="webinar-available-slot">Available Slots - 23</div><div class="radio-button-checked-div"><img src="https://assets-global.website-files.com/5d0cef7a72ca1b074065dfda/6530d9514b79e8487a5c9c77_check%20(2)%201.png" loading="lazy" alt="" class="radio-button-checked-icon"></div></label></div > ',
      ...
      "v2" == webinarUI ? ($(".calender-box").append($(c)), $(".calender-box").addClass("slot-grid"), $(".ws-available-slots").css("color", "#0E9F1C"), $(".ws-card:first-child").find(".ws-available-slots").css("color", "#D14040"), $(".ws-card:nth-child(2)").find(".ws-available-slots").css("color", "#ED7735"), $(".ws-card").find(".ws-almost-full").hide(), $(".ws-card:first-child").find(".ws-almost-full").show(), $(".ws-card:nth-child(2)").find(".ws-almost-full").text("Filling fast!").addClass("ws-filling-fast"), $(".ws-filling-fast").css("display", "block")) : $(".calender-box").append($(m))
    }
  }
