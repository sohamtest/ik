...
$(document).ready(function () {
  ...
  $('.bc__btn-2nd-step').click(function (e) {
    ...
    if ($("input:radio[name='start-date']").is(":checked")) {
      ...
      let utmStringNew = "?utm_source=" + $(".utm_source").val() + "&utm_medium=" + utmm + "&salesforce_uuid=" + sf_uuid;

      let finalurl;
      if (window.location.href == "https://learn.interviewkickstart.com/home-v15") {
        if ($('.bye-calendly-type').val() == "NoPhoneInTheFirstStep") {
          finalurl = "https://www.interviewkickstart.com/signup-final-step-v6" + utmstring;
        } else {
          finalurl = "https://www.interviewkickstart.com/signup-final-step-v8" + utmStringNew;
        }
      }
      else if ($('.bye-calendly-type').val() == "NoPhoneInTheFirstStep") {
        finalurl = "https://www.interviewkickstart.com/signup-final-step-v6" + utmstring;
      } else {
        finalurl = "https://www.interviewkickstart.com/signup-final-step" + utmStringNew;
      }
