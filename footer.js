<script>
    ...
    var v_ccode = "";
    var int_phone;
  	var v_timezone = Intl.DateTimeFormat().resolvedOptions().timeZone;
    var iksite_url = window.location.hostname;
...
<script>
  $(document).ready(function() {
    ...
    var jqxhr = $.getJSON( "https://get.geojs.io/v1/ip/geo.json", function(data) {})
    .done(function(data) {
      v_city = data.city;
      v_ccode = data.country_code;
    })
    .fail(function(data) {
      //
    });
...
window.cookieconsent.initialise({
  ...
  "theme": "classic",
  "content": {
    "message": "We use cookies to enable the best possible experience on our site and to optimize the content for you. If you continue surfing you agree.",
...
<script>
  ...
  function create_UUID(){
    ...
    return uuid+"-ik-"+uniqueId();
  }
  
  var visitor_id = getCookie("unique_visitor_id2");
  
  var expdate = new Date();
  expdate.setTime(expdate.getTime()+(365*24*60*60*1000));
  
  if(visitor_id == ""){
    setCookie("unique_visitor_id2",create_UUID());
    visitor_id = getCookie("unique_visitor_id2");
  }
  ...
  if(utm_params_url['gh_jid'] != undefined){
  	utm_params_url = {};
    $('.careers-sec1, .careers-sec2, .careers-sec3, .careers-sec4').hide();
  }
